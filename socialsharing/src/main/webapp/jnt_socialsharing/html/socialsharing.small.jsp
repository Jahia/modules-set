...
<ul class="socialsharing-small">
    <c:forEach items="${currentNode.properties.socialNetworks}" var="socialNetwork">
        <li>
            ...
            ${currentNode.properties['jcr:title'].string}<a href="${shareUrl}"><img src="<c:url value='${url.currentModule}/images/${socialNetwork.string}_16.png'/>" alt="${socialNetwork.string}" /></a>
        </li>
    </c:forEach>
</ul>